...
# One of your robots is charged with a simple task: to join a sequence of strings in one sentence
# to produce instructions on how to get around the ship.
...
# As a joke on the right handed robots, you should replace all cases of the words "right"
